...
export function Chat(props: {
  ...
  const a = "请帮我用小学知识做以下这道题，尽量使用150字内精简地分别写出考查知识点、解题思路、解题过程。运算过程不能带单位运算，结果带单位；式子的结果的单位用中文括号括（）起来；乘法符号用×。你必须严格按照我给出的格式回答：【分析】(换行)本题考查α。解题思路是β。（换行）【解答】（换行）解：γ。（换行）答：以下是问题：\n";
